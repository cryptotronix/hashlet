...
#define WRITE_CONFIG_NEVER_MASK    0b00000100
#define WRITE_CONFIG_ENCRYPT_MASK  0b00000010

#define CHECK_ONLY_MASK     0b00001000
#define SINGLE_USE_MASK     0b00000100
#define ENCRYPTED_READ_MASK 0b00000010
#define IS_SECRET_MASK      0b00000001
