...
#define WRITE_CONFIG_ALWAYS_MASK   0b11111000
#define WRITE_CONFIG_NEVER_MASK    0b11111101
#define WRITE_CONFIG_ENCRYPT_MASK  0b11111010

#define CHECK_ONLY_MASK     0b1111100000000000
#define SINGLE_USE_MASK     0b1111110000000000
#define ENCRYPTED_READ_MASK 0b1111111000000000
#define IS_SECRET_MASK      0b1111111100000000
